...
class FanceletController extends Controller
{
	...
	public function addContentLike(FanceletCanLikeRequest $request, int $productId, string $productPass, string $contentType, int $contentId){
