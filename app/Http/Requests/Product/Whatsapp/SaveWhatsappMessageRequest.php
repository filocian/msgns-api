...
namespace App\Http\Requests\Product\Whatsapp;
...
final class SaveWhatsappMessageRequest extends FormRequest
{
	/**
	...
	{
		return [
			'phone_id' => 'int|required',
			'message_locale_id' => 'int|required',
