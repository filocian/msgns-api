...
final class RejectAiResponseHandler implements CommandHandler
{
    public function handle(Command $command): mixed
    {
        assert($command instanceof RejectAiResponseCommand);
        ...
        $newStatus = $currentStatus->transitionTo(AiResponseStatus::from(AiResponseStatus::REJECTED));
