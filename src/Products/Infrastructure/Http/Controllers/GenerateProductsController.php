...
use Src\Products\Infrastructure\Http\Requests\GenerateProductsRequest;
...
final class GenerateProductsController
{
    ...
    public function __invoke(GenerateProductsRequest $request): JsonResponse|BinaryFileResponse
    {
        $items = array_map(
