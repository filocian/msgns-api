...
use Src\Products\Infrastructure\Http\Requests\SetTargetUrlRequest;
use Src\Shared\Core\Bus\CommandBus;
use Src\Shared\Infrastructure\Http\ApiResponseFactory;

final class SetTargetUrlController
{
    ...
    public function __invoke(SetTargetUrlRequest $request, int $id): JsonResponse
    {
