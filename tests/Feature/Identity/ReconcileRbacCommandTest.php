...
describe('artisan rbac:reconcile', function () {
    ...
    it('seeds all 24 permissions into Spatie tables with stateful-api guard', function () {
        $this->artisan('rbac:reconcile')->assertExitCode(0);
    ...
    it('assigns all 24 permissions to developer role', function () {
        ...
        expect($role->permissions)->toHaveCount(24);
    });
    ...
    it('is idempotent — running twice does not change the state', function () {
        ...
        // Permissions count should be exactly 24 (no duplicates)
